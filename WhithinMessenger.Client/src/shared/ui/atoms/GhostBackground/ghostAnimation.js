...
class PreloaderManager {
  constructor() {
    this.preloader = document.querySelector('.ghost-background .preloader');
    this.mainContent = document.querySelector('.ghost-background .main-content');
    this.progressBar = document.querySelector('.ghost-background .progress-bar');
    this.loadingSteps = 0;
...
renderer.setClearColor(0x000000, 0);
         ...
         if (container) {
           ...
           console.log('Canvas added to document.body (fallback)');
         }
...
const params = {
  ...
  // Glow effects - updated to match user requirements
  emissiveIntensity: 10.0,
  pulseSpeed: 1.6,
  pulseIntensity: 0.6,

  // Eyes - updated to match user requirements
  ...
  // Behavior - updated to match user requirements
  followSpeed: 0.075,
  wobbleAmount: 0.35,
  floatSpeed: 1.6,
  ...
  // Background reveal - updated to match user requirements
  revealRadius: 41,
  fadeStrength: 2.2,
  baseOpacity: 0.70,
  revealOpacity: 0.0,
  ...
  // Analog Decay settings - updated to match user requirements
  analogIntensity: 0.5,
  analogGrain: 0.4,
  analogBleeding: 0.8,
  analogVSync: 3.0,
...
function forceInitialRender() {
  console.log('Force initial render called');
...
function animate(timestamp) {
  ...
  if (!isInitialized) {
    console.log("Animation not initialized yet, frame:", frameCount);
    return;
  }
...
export const initializeGhostAnimation = (preloaderParam) => {
  ...
  if (preloaderParam) {
    ...
    preloaderParam.complete();
  }
};

// Animation will be initialized when initializeGhostAnimation is called
