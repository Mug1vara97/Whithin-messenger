          ...
          <div className="tile-bottom-overlay">
            <div className="bottom-info">
              <div className={`mic-status ${isMuted ? 'muted' : isSpeaking ? 'speaking' : 'silent'}`}>
                {isMuted ? (
                  <MicOffIcon sx={{ fontSize: isSmall ? 14 : 16, color: '#ed4245' }} />
                ) : isSpeaking ? (
                  <MicIcon sx={{ fontSize: isSmall ? 14 : 16, color: '#3ba55c' }} />
                ) : (
                  <MicIcon sx={{ fontSize: isSmall ? 14 : 16, color: '#B5BAC1' }} />
                )}
              </div>
              {!isAudioEnabled && (
                <div className="headset-status">
                  <HeadsetOffIcon sx={{ fontSize: isSmall ? 14 : 16, color: '#ed4245' }} />
                </div>
              )}
