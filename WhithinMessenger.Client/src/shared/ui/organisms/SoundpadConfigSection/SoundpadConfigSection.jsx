      ...
      <section className="soundpad-section">
        ...
        <p className="soundpad-hint">
          {config.soundpadMode === 'system'
            ? 'Микрофон и саундпад идут через VB-Cable в другие приложения. В звонке Whithin при включённом шумоподавлении обрабатывается только физический микрофон — звуки саундпада остаются чистыми.'
            : 'Звук миксуется с микрофоном в Whithin. Саундпад слышен даже при выключенном микрофоне. Шумоподавление обрабатывает только голос, не звуки саундпада.'}
        </p>
      </section>
