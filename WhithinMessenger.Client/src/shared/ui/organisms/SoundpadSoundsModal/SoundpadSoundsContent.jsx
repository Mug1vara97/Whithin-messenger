...
const SoundpadSoundsContent = ({ active = true }) => {
  ...
  useEffect(() => {
    const onConfigChange = () => {
      ...
      setShowPanel(config.showPanel !== false);
  ...
  const handlePlaySlot = async (slotId) => {
    ...
    try {
      ...
      soundpadError('SoundpadSoundsContent: play failed', err);
      setError(err.message || String(err));
    }
  };
  ...
  return (
    <div className="soundpad-sounds-content">
...
export default SoundpadSoundsContent;
