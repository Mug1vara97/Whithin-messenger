...
const OUTPUT_GAIN_MAX = 1;
export const DEFAULT_CALL_OUTPUT_GAIN = 1;
export const OUTPUT_VOLUME_PERCENT_MAX = 100;
...
export function getCallOutputGain() {
  ...
  const gain = stored > 0 ? stored : DEFAULT_CALL_OUTPUT_GAIN;
