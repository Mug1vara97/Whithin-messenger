...
export const useGlobalCall = (userId = null, userName = null) => {
  ...
  return {
    ...
    toggleScreenShareMute: callContext.toggleScreenShareMute,
    changeScreenShareVolume: callContext.changeScreenShareVolume,
    toggleScreenShareVolumeSlider: callContext.toggleScreenShareVolumeSlider,
