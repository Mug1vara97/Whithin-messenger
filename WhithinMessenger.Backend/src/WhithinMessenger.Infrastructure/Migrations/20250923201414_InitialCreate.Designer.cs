...
namespace WhithinMessenger.Infrastructure.Migrations
{
    ...
    [Migration("20250923201414_InitialCreate")]
            ...
            modelBuilder.Entity("WhithinMessenger.Domain.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2025, 9, 23, 20, 14, 14, 36, DateTimeKind.Unspecified).AddTicks(191), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("WhithinMessenger.Domain.Models.AuditLog", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2025, 9, 23, 20, 14, 14, 39, DateTimeKind.Unspecified).AddTicks(6493), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("WhithinMessenger.Domain.Models.Chat", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2025, 9, 23, 20, 14, 14, 43, DateTimeKind.Unspecified).AddTicks(2882), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("WhithinMessenger.Domain.Models.Member", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("JoinedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2025, 9, 23, 20, 14, 14, 45, DateTimeKind.Unspecified).AddTicks(3787), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("WhithinMessenger.Domain.Models.Message", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2025, 9, 23, 20, 14, 14, 46, DateTimeKind.Unspecified).AddTicks(8460), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("WhithinMessenger.Domain.Models.MessageRead", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("ReadAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2025, 9, 23, 20, 14, 14, 56, DateTimeKind.Unspecified).AddTicks(7817), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("WhithinMessenger.Domain.Models.Notification", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2025, 9, 23, 20, 14, 14, 61, DateTimeKind.Unspecified).AddTicks(3300), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("WhithinMessenger.Domain.Models.Server", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2025, 9, 23, 20, 14, 14, 69, DateTimeKind.Unspecified).AddTicks(5122), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("WhithinMessenger.Domain.Models.ServerAuditLog", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("Timestamp")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2025, 9, 23, 20, 14, 14, 68, DateTimeKind.Unspecified).AddTicks(5901), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("WhithinMessenger.Domain.Models.ServerMember", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("JoinedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2025, 9, 23, 20, 14, 14, 70, DateTimeKind.Unspecified).AddTicks(6541), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("WhithinMessenger.Domain.Models.ServerRole", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2025, 9, 23, 20, 14, 14, 72, DateTimeKind.Unspecified).AddTicks(1117), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("WhithinMessenger.Domain.Models.UserServerRole", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("AssignedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2025, 9, 23, 20, 14, 14, 76, DateTimeKind.Unspecified).AddTicks(3768), new TimeSpan(0, 0, 0, 0, 0)));
