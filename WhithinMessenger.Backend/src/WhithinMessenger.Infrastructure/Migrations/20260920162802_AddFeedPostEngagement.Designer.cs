...
namespace WhithinMessenger.Infrastructure.Migrations
{
    ...
    [Migration("20260920162802_AddFeedPostEngagement")]
    partial class AddFeedPostEngagement
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WhithinMessenger.Domain.Models.ChatE2eWrappedKey", b =>
                {
                    ...
                    b.Property<string>("ChatKeyFingerprint")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
            ...
            modelBuilder.Entity("WhithinMessenger.Domain.Models.FeedPost", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Scope", "CreatedAt");

                    b.HasIndex("ServerId", "CreatedAt");

                    b.HasIndex("AuthorUserId", "Scope", "CreatedAt");

                    b.ToTable("FeedPosts", (string)null);
                });

            modelBuilder.Entity("WhithinMessenger.Domain.Models.FeedPostAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("FeedPostAttachments", (string)null);
                });

            modelBuilder.Entity("WhithinMessenger.Domain.Models.FeedPostComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("FeedPostId", "CreatedAt");

                    b.ToTable("FeedPostComments", (string)null);
                });

            modelBuilder.Entity("WhithinMessenger.Domain.Models.FeedPostReaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("FeedPostReactions", (string)null);
                });
            ...
            modelBuilder.Entity("WhithinMessenger.Domain.Models.IdeaBoardCard", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WhithinMessenger.Domain.Models.MessageDelivery", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WhithinMessenger.Domain.Models.PendingPasswordChange", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WhithinMessenger.Domain.Models.PendingPasswordReset", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WhithinMessenger.Domain.Models.UserE2eKeyBackup", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("UserE2eKeyBackups", (string)null);
                });
            ...
            modelBuilder.Entity("WhithinMessenger.Domain.Models.UserProfile", b =>
                {
                    ...
                    b.Property<string>("AvatarDecoration")
                        .HasMaxLength(255)
                        .HasColumnType("character varying(255)");
            ...
            modelBuilder.Entity("WhithinMessenger.Domain.Models.FeedPost", b =>
                {
                    b.HasOne("WhithinMessenger.Domain.Models.ApplicationUser", "Author")
                        .WithMany()
            ...
            modelBuilder.Entity("WhithinMessenger.Domain.Models.FeedPostAttachment", b =>
                {
                    b.HasOne("WhithinMessenger.Domain.Models.FeedPost", "FeedPost")
            ...
            modelBuilder.Entity("WhithinMessenger.Domain.Models.Friendship", b =>
                {
                    b.HasOne("WhithinMessenger.Domain.Models.ApplicationUser", "Addressee")
                        .WithMany()
                        .HasForeignKey("AddresseeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WhithinMessenger.Domain.Models.ApplicationUser", "Requester")
                        .WithMany()
